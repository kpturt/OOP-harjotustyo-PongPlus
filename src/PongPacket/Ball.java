...
public class Ball {
    ...
    // Restarts ball position, direction and speed multiplier
    public void restartBall() {
        ...
        // initializes a random starting direction for the ball for each round
        rnd.nextInt(4);
        if (rnd.nextInt(4) == 0) {
            dirX = -2;
            dirY = 2;
    ...
    // Updates ball speed based on elapsed time
